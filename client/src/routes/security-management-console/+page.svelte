    ...
    <html lang="en-US" class="h-full bg-gray-100">
        ...
        <header class="bg-white shadow">
          <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Security Dashboard</h1>
          </div>
        </header>
        <main>
          <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <div class="mx-4 my-2 lg:flex lg:items-center lg:justify-between">
              <div class="min-w-0 flex-1">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-2.5xl sm:tracking-tight">Today's Exit Register</h2>
